      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="card border-[var(--accent-border)] bg-[var(--accent-soft)] p-5 sm:p-6">
            <p className="card-label mb-3 text-[var(--accent)]">
          ...
          <div className="card p-5 sm:p-6">
            <p className="card-label mb-3">Tokenized {quote.symbol}</p>
        ...
        <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
          {[
            { label: "Ratio", value: pool.ratio != null ? pool.ratio.toPrecision(4) : "—" },
